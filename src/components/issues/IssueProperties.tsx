  ...
  return (
    <aside className="hidden lg:flex flex-col w-[260px] min-w-[220px] max-w-[320px] bg-transparent px-4 py-6">
      ...
      <div className="flex flex-col gap-4 mt-2">
        <button className="flex items-center w-full gap-2 px-3 py-2.5 rounded-lg hover:bg-[#18181b] transition text-[15px] font-medium text-[#bdbdbd] h-10">
          <StatusIcon />
      ...
      {/* Labels 分组 */}
      <div className="mt-6 mb-2 text-xs text-[#7c7c8a] font-normal px-1">
        Labels
      </div>
      <button className="flex items-center w-full gap-2 px-3 py-2.5 rounded-lg hover:bg-[#18181b] transition text-[15px] font-medium text-[#bdbdbd] h-10">
