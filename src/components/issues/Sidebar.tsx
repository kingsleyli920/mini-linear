          ...
          <>
            ...
            <div className="fixed left-0 top-0 h-full w-64 z-[9999] flex flex-col bg-[#101011] shadow-2xl animate-slide-in">
              ...
              <div className="flex items-center gap-2 px-3 mt-4 mb-2">
                <div className="w-8 h-8 rounded-full bg-[#7c3aed] flex items-center justify-center text-white font-bold text-base">
              ...
              <nav className="flex flex-col gap-1">
                {navigation.slice(0, 3).map((item) => (
                  <button
                    key={item.name}
                    className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-[15px] font-medium text-[#bdbdbd] hover:text-[#e2e2e2] hover:bg-[#23272e] transition"
                  >
    ...
    <div className="hidden sm:flex sm:w-64 w-0 flex-col bg-[#101011] h-full">
      ...
      <nav className="flex-1 overflow-y-auto px-0 py-2">
        ...
        <div className="flex flex-col gap-0.5 mt-2">
          <button className="flex items-center gap-2 px-3 py-1.5 rounded-md text-[15px] font-medium text-[#e2e2e2] bg-[#23272e]">
            <InboxIcon className="w-4 h-4 mr-2" />
            Inbox
          </button>
          <button className="flex items-center gap-2 px-3 py-1.5 rounded-md text-[15px] font-medium text-[#bdbdbd] hover:text-[#e2e2e2] hover:bg-[#23272e] transition">
            <svg
        ...
        {/* Workspace 分组 */}
        <div className="text-xs text-[#7c7c8a] font-normal px-3 mb-1 mt-5">
          Workspace
        </div>
        ...
        <div className="flex flex-col gap-0.5">
          ...
          <button className="flex items-center gap-2 px-3 py-1.5 rounded-md text-[15px] font-medium text-[#e2e2e2] bg-[#23272e] mt-1">
            <svg
              className="w-4 h-4 mr-2"
              fill="none"
              stroke="#bdbdbd"
